...
//
MTypeId TestNodeB::m_id( 0x00001 );
MString TestNodeB::m_classification("shader/surface");
VersionHelper TestNodeB::m_version_helper;
///////////////////////////////////////////////////////
// DESCRIPTION: attribute information
///////////////////////////////////////////////////////
//
MObject  TestNodeB::aAttribute0;
MObject  TestNodeB::aOutColor;
...
//
void TestNodeB::postConstructor()
{
...
MString TestNodeB::cTypeName()
{
	return "testNodeB";
}

MTypeId TestNodeB::cTypeId()
{
	return TestNodeB::m_id;
}

MPxNode::Type TestNodeB::cType()
{
	return MPxNode::kDependNode;
}

const MString& TestNodeB::classification()
{
...
// method.
//
// In this case creator simply returns a new TestNodeB object.
//

void* TestNodeB::creator()
{
	return new TestNodeB();
}
...
MStatus TestNodeB::initialize()
{
	...
	CHECK_MSTATUS( nAttr.setDefault( 0.644f, 0.0f, 0.121f ) );
...
//
MStatus TestNodeB::compute( const MPlug& plug, MDataBlock& block )
{
